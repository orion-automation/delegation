...
import com.eorion.bo.enhancement.delegation.domain.commom.ErrorMessage;
import com.eorion.bo.enhancement.delegation.domain.exception.IllegalParameterException;
...
@Log4j2
public class DelegationRestControllerAdvice {
    /**
     * 参数格式错误
     *
     * @param e
